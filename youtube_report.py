...
## 리스크 / 전략
화자가 제시한 리스크와 매매 전략을 **우선순위 순** bullet 으로 압축. 각 한 줄.

**문체**: 스토리 섹션은 친근하고 쉬운 말로, 비유를 곁들여 확 와닿게 풀어 쓸 것(미사여구·과장은 X, 쉬움 ≠ 유치). 표/요약/리스크는 단편·명사구 OK. 단 비유·해석은 자막에 있는 사실을 쉽게 옮기는 용도일 뿐, 자막에 없는 내용을 지어내지 말 것. 추측·일반론 금지.
